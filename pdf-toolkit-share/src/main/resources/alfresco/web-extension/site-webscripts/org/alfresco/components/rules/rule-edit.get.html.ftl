<@markup id="css" >
   ...
   <@link href="${url.context}/res/modules/document-picker/document-picker.css" group="rules_custom"/>
</@>
...
<@markup id="js">
   ...
   <@script src="${url.context}/res/modules/document-picker/document-picker.js" group="rules_custom"/>
   <@script type="text/javascript" src="${url.context}/res/pdftoolkit/js/pdftoolkit-rule-config-actions.js" group="rules_custom"></@script>
</@>
